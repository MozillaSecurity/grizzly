...
def test_stack_03():
    ...
    frames = list()
    for _ in range(2):
        frames.append(StackFrame(function="a", location="b", offset="c", stack_line="0"))
...
def test_stack_04():
    ...
    frames = list()
    for line in range(2):
        frames.append(StackFrame(function="a", location="b", offset="c", stack_line=str(line)))
...
def test_stack_13():
    ...
    assert stack.frames[0].function == "std::sys::unix::backtrace::tracing::imp::unwind_backtrace"
